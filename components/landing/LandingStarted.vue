...
<style scoped>
section {
  @apply px-4 py-6 bg-gray-100;
}

.landing-started {
  @apply lg:max-w-screen-2xl lg:mx-auto lg:px-12 lg:py-12;
}

h2 {
  @apply text-4xl text-center font-semibold mb-8;
}
...
.steps {
  @apply lg:flex lg:justify-between lg:gap-8 xl:gap-12;
}
